import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, mergeProps, unref, withCtx, renderSlot, createBlock, openBlock, defineComponent, createVNode, resolveDynamicComponent, hasInjectionContext, getCurrentInstance, inject, toValue, onServerPrefetch, shallowRef, h, resolveComponent, useSlots, ref, createCommentVNode, toDisplayString, watch, toRef, createTextVNode, mergeModels, useModel, useAttrs, useTemplateRef, provide, isRef, useId, toHandlers, nextTick, reactive, withModifiers, Fragment, renderList, shallowReactive, markRaw, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, Suspense, createApp, onErrorCaptured, effectScope, isReadonly, isShallow, isReactive, toRaw, getCurrentScope } from 'vue';
import { s as serialize, k as defu, f as createError$1, l as parseQuery, m as defuFn, n as klona, o as isEqual, q as getContext, r as hasProtocol, t as joinURL, w as withQuery, v as withTrailingSlash, x as withoutTrailingSlash, y as isScriptProtocol, z as sanitizeStatusCode, A as withLeadingSlash, B as parseURL, $ as $fetch$1, C as baseURL, D as createHooks, E as executeAsync, F as toRouteMatcher, G as createRouter$1, H as encodeParam, I as encodePath } from '../nitro/nitro.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import colors from 'tailwindcss/colors';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderVNode, ssrRenderClass, ssrInterpolate, ssrRenderAttrs, ssrRenderList, ssrRenderStyle, ssrRenderSuspense } from 'vue/server-renderer';
import { useForwardProps, Primitive, Slot, ConfigProvider, TooltipProvider, useForwardPropsEmits, VisuallyHidden, DialogRoot, DialogTrigger, DialogPortal, DialogOverlay, DialogContent, DialogTitle, DialogDescription, DialogClose, AccordionTrigger, AccordionItem, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuLink, NavigationMenuContent, AccordionContent, AccordionRoot, NavigationMenuRoot, NavigationMenuList, NavigationMenuIndicator, NavigationMenuViewport, ToastProvider, ToastPortal, ToastViewport, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, ProgressRoot, ProgressIndicator } from 'reka-ui';
import { reactiveOmit, reactivePick, createSharedComposable, createReusableTemplate } from '@vueuse/core';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./_...slug_-CdZC5szD.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-YH2GJU0y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-jP0kYyCc.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-B29gikhj.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-SmvL1rh8.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BvR2l8Mp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-DouIN0tw.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-DqtjcYa8.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-8RBJZv4o.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-DWE5tnfC.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-tfgvF6Yy.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-CCb3sssT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-Q9XrqC05.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-BkUcKP2_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-BccrdU9M.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-CqV2kUhd.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-CqBdV4DU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-Y6ecTdk5.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-BUEjMY03.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-R4czgHPr.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-vY1cAO4d.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-PfTK-f92.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-Dk7-R9It.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-DjOvooc5.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseAccordion = defineAsyncComponent(() => import('./Accordion-CQscQ-gr.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseAccordionItem = defineAsyncComponent(() => import('./AccordionItem-CKtmJJ4j.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBadgeDVue = defineAsyncComponent(() => import('./Badge.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBadge = defineAsyncComponent(() => import('./Badge-9qaz5rSU.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseCallout = defineAsyncComponent(() => import('./Callout-RkgUAAsI.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCardDVue = defineAsyncComponent(() => import('./Card.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCard = defineAsyncComponent(() => import('./Card-CwVqDFDa.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCardGroupDVue = defineAsyncComponent(() => import('./CardGroup.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCardGroup = defineAsyncComponent(() => import('./CardGroup-CV1c3IRJ.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseCodeCollapse = defineAsyncComponent(() => import('./CodeCollapse-CRfD8Z_3.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeGroupDVue = defineAsyncComponent(() => import('./CodeGroup.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeGroup = defineAsyncComponent(() => import('./CodeGroup-B62LrFqW.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeIconDVue = defineAsyncComponent(() => import('./CodeIcon.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeIcon = defineAsyncComponent(() => import('./CodeIcon-CmEInbpT.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodePreviewDVue = defineAsyncComponent(() => import('./CodePreview.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodePreview = defineAsyncComponent(() => import('./CodePreview-CIlh95xY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeTreeDVue = defineAsyncComponent(() => import('./CodeTree.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeTree = defineAsyncComponent(() => import('./CodeTree-YPyhpbfQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCollapsibleDVue = defineAsyncComponent(() => import('./Collapsible.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCollapsible = defineAsyncComponent(() => import('./Collapsible-Dr4jlY8B.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseField = defineAsyncComponent(() => import('./Field-pdkH8Td1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseFieldGroupDVue = defineAsyncComponent(() => import('./FieldGroup.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseFieldGroup = defineAsyncComponent(() => import('./FieldGroup-BXMcGeyL.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseIcon = defineAsyncComponent(() => import('./Icon-D5vJcJKW.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseKbd = defineAsyncComponent(() => import('./Kbd-DAXOXbtE.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseSteps = defineAsyncComponent(() => import('./Steps-D1JClPyA.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseTabs = defineAsyncComponent(() => import('./Tabs-BlORy80Q.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTabsItemDVue = defineAsyncComponent(() => import('./TabsItem.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTabsItem = defineAsyncComponent(() => import('./TabsItem-GLjvyYC4.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseCaution = defineAsyncComponent(() => import('./Caution-4TcVZF7c.mjs').then((r) => r["default"] || r.default || r));
const LazyProseNoteDVue = defineAsyncComponent(() => import('./Note.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseNote = defineAsyncComponent(() => import('./Note-6xkea9N0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTipDVue = defineAsyncComponent(() => import('./Tip.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTip = defineAsyncComponent(() => import('./Tip-DZI-gPjl.mjs').then((r) => r["default"] || r.default || r));
const LazyProseWarningDVue = defineAsyncComponent(() => import('./Warning.d.vue-BTDBFo2Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseWarning = defineAsyncComponent(() => import('./Warning-Bd2DIVib.mjs').then((r) => r["default"] || r.default || r));
...
const ipxRuntime$z4KzBdTFaKTrm1uBos0PNncmJgAaBq89EDfA3cXMsGo = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$z4KzBdTFaKTrm1uBos0PNncmJgAaBq89EDfA3cXMsGo, defaults: {} }
  }
};
...
const ImageComponent = Object.assign(_sfc_main$t, { __name: "NuxtImg" });
...
const _sfc_main$s = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$j), ...appConfig2.ui?.chip || {} })({
      color: props.color,
      size: size.value,
...
const _sfc_main$r = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const { size } = useAvatarGroup(props);
    const ui = computed(() => tv({ extend: tv(theme$i), ...appConfig2.ui?.avatar || {} })({
      size: size.value
    }));
...
const _sfc_main$n = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$f), ...appConfig2.ui?.progress || {} })({
...
const _sfc_main$m = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$e), ...appConfig2.ui?.toast || {} })({
      color: props.color,
      orientation: props.orientation,
...
const _sfc_main$l = /* @__PURE__ */ Object.assign(__default__$1, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$d), ...appConfig2.ui?.toaster || {} })({
      position: props.position,
...
const __nuxt_component_0 = Object.assign(_sfc_main$j, { __name: "UApp" });
const layouts = {
  default: defineAsyncComponent(() => import('./default-BHPYxz4l.mjs').then((m) => m.default || m)),
  timeout: defineAsyncComponent(() => import('./timeout-CViN_W_Z.mjs').then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_UApp, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_NuxtLayout, { name: "timeout" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
        ...
        return [
          createVNode(_component_NuxtLayout, { name: "timeout" }, {
            default: withCtx(() => [
              createVNode(_component_NuxtPage)
            ]),
            _: 1
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["ssrRender", _sfc_ssrRender]]);
const theme$c = {
...
const _sfc_main$h = {
  ...
  setup(__props) {
    const props = __props;
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$c), ...appConfig2.ui?.container || {} }));
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
...
const _sfc_main$g = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$b), ...appConfig2.ui?.slideover || {} })({
...
const _sfc_main$e = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$9), ...appConfig2.ui?.drawer || {} })({
...
const _sfc_main$d = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$8), ...appConfig2.ui?.header || {} })());
    const Menu = computed(() => ({
          ...
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "toggle", {
                ...
                __props.toggle ? (openBlock(), createBlock(_sfc_main$o, mergeProps({
                  key: 0,
                  color: "neutral",
                  variant: "ghost",
                  "aria-label": open.value ? unref(t)("header.close") : unref(t)("header.open"),
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                          ...
                          item.badge !== void 0 ? (openBlock(), createBlock(_sfc_main$c, mergeProps({
                            key: 0,
                            color: "neutral",
                            variant: "outline",
                            size: item.ui?.linkTrailingBadgeSize || props.ui?.linkTrailingBadgeSize || ui.value.linkTrailingBadgeSize()
                          ...
                          __props.orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || __props.orientation === "vertical" && item.children?.length ? (openBlock(), createBlock(_sfc_main$u, {
                            key: 1,
                            name: item.trailingIcon || __props.trailingIcon || unref(appConfig2).ui.icons.chevronDown,
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
                          }, null, 8, ["name", "class"])) : item.trailingIcon ? (openBlock(), createBlock(_sfc_main$u, {
                            key: 2,
                            name: item.trailingIcon,
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
                          }, null, 8, ["name", "class"])) : createCommentVNode("", true)
              ...
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.avatar ? (openBlock(), createBlock(_sfc_main$r, mergeProps({
                    ...
                    class: ui.value.linkLeadingAvatar({ class: [props.ui?.linkLeadingAvatar, item.ui?.linkLeadingAvatar], active, disabled: !!item.disabled })
                  }), null, 16, ["size", "class"])) : item.icon ? (openBlock(), createBlock(_sfc_main$u, {
                    key: 1,
                    name: item.icon,
                    class: ui.value.linkLeadingIcon({ class: [props.ui?.linkLeadingIcon, item.ui?.linkLeadingIcon], active, disabled: !!item.disabled })
                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                ...
                (!__props.collapsed || __props.orientation !== "vertical") && (unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"]) ? (openBlock(), createBlock("span", {
                  ...
                  item.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$u, {
                    key: 0,
                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig2).ui.icons.external,
                    class: ui.value.linkLabelExternalIcon({ class: [props.ui?.linkLabelExternalIcon, item.ui?.linkLabelExternalIcon], active })
                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
              ...
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (__props.orientation === "vertical" && item.type === "label" && !__props.collapsed) {
                    ...
                    _push3(ssrRenderComponent(_sfc_main$p, mergeProps(__props.orientation === "vertical" && item.children?.length && !__props.collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
                            ...
                            default: withCtx((_2, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                if (__props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover)) {
                                  _push5(ssrRenderComponent(_sfc_main$b, mergeProps({ ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                      ...
                                      if (_push6) {
                                        ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
                                          ...
                                          ssrRenderList(item.children, (childItem, childIndex) => {
                                            ...
                                            _push6(ssrRenderComponent(_sfc_main$p, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(unref(NavigationMenuLink), {
                                                    ...
                                                    default: withCtx((_3, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        _push8(ssrRenderComponent(_sfc_main$q, mergeProps({ ref_for: true }, childSlotProps, {
                                                          ...
                                                          default: withCtx((_4, _push9, _parent9, _scopeId8) => {
                                                            if (_push9) {
                                                              if (childItem.icon) {
                                                                _push9(ssrRenderComponent(_sfc_main$u, {
                                                                  name: childItem.icon,
                                                              ...
                                                              return [
                                                                childItem.icon ? (openBlock(), createBlock(_sfc_main$u, {
                                                                  key: 0,
                                                                  name: childItem.icon,
                                                                  class: ui.value.childLinkIcon({ class: [props.ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
                                                                }, null, 8, ["name", "class"])) : createCommentVNode("", true),
                                                                createVNode("span", {
                                                                  ...
                                                                  childItem.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$u, {
                                                                    key: 0,
                                                                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig2).ui.icons.external,
                                                                    class: ui.value.childLinkLabelExternalIcon({ class: [props.ui?.childLinkLabelExternalIcon, item.ui?.childLinkLabelExternalIcon], active: childActive })
                                                                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                                    ...
                                    default: withCtx((_3, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(ssrRenderComponent(_sfc_main$q, mergeProps(slotProps, {
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$b, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ui: { content: ui.value.content({ class: [props.ui?.content, item.ui?.content] }) }
                                  }), {
                                    ...
                                    _: 2
                                  }, 1040, ["ui"])) : __props.orientation === "vertical" && __props.collapsed && (!!props.tooltip || !!item.tooltip) ? (openBlock(), createBlock(_sfc_main$9, mergeProps({
                                    key: 1,
                                    text: unref(get)(item, props.labelKey)
                                  }, { ...tooltipProps.value, ...typeof item.tooltip === "boolean" ? {} : item.tooltip || {} }), {
                                    default: withCtx(() => [
                                    ...
                                    _: 2
                                  }, 1040, ["text"])) : (openBlock(), createBlock(_sfc_main$q, mergeProps({ key: 2 }, slotProps, {
                                    class: ui.value.link({ class: [props.ui?.link, item.ui?.link, item.class], active: active || item.active, disabled: !!item.disabled, level: __props.orientation === "horizontal" || level > 0 })
                                  }), {
                                    default: withCtx(() => [
                                      createVNode(unref(ReuseLinkTemplate), {
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$q, mergeProps({ ref_for: true }, childSlotProps, {
                                                    ...
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        if (childItem.icon) {
                                                          _push8(ssrRenderComponent(_sfc_main$u, {
                                                            name: childItem.icon,
                                                            class: ui.value.childLinkIcon({ class: [props.ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
                  ...
                  return [
                    ...
                    ], 2)) : item.type !== "label" ? (openBlock(), createBlock(_sfc_main$p, mergeProps({ key: 1 }, __props.orientation === "vertical" && item.children?.length && !__props.collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UNavigationMenu = _sfc_main$8;
      _push(ssrRenderComponent(_component_UNavigationMenu, mergeProps({ items: unref(navigation) }, _attrs), null, _parent));
    };
  }
});
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/app/navigation.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const __nuxt_component_2 = Object.assign(_sfc_main$7, { __name: "AppNavigation" });
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  __name: "header",
  __ssrInlineRender: true,
  setup(__props) {
    const header = {
      title: useAppConfig().app.head.title
    };
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UHeader = _sfc_main$d;
      const _component_UButton = _sfc_main$o;
      const _component_AppNavigation = __nuxt_component_2;
      _push(ssrRenderComponent(_component_UHeader, _attrs, {
        ...
        right: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createVNode(_component_AppNavigation)
            ];
          }
        }),
        _: 1
...
const __nuxt_component_1 = Object.assign(_sfc_main$6, { __name: "AppHeader" });
const theme$2 = {
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const { t } = useLocale();
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$1), ...appConfig2.ui?.error || {} })());
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!!props.error?.statusCode || !!slots.statusCode) {
              _push2(`<p class="${ssrRenderClass(ui.value.statusCode({ class: props.ui?.statusCode }))}"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "statusCode", {}, () => {
                _push2(`${ssrInterpolate(props.error?.statusCode)}`);
              }, _push2, _parent2, _scopeId);
              _push2(`</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (!!props.error?.statusMessage || !!slots.statusMessage) {
              _push2(`<h1 class="${ssrRenderClass(ui.value.statusMessage({ class: props.ui?.statusMessage }))}"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "statusMessage", {}, () => {
                _push2(`${ssrInterpolate(props.error?.statusMessage)}`);
              }, _push2, _parent2, _scopeId);
              _push2(`</h1>`);
            } else {
              _push2(`<!---->`);
            }
            if (props.error?.message && props.error.message !== props.error.statusMessage || !!slots.message) {
              _push2(`<p class="${ssrRenderClass(ui.value.message({ class: props.ui?.message }))}"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "message", {}, () => {
                _push2(`${ssrInterpolate(props.error?.message)}`);
              }, _push2, _parent2, _scopeId);
              _push2(`</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (!!__props.clear || !!slots.links) {
            ...
            return [
              !!props.error?.statusCode || !!slots.statusCode ? (openBlock(), createBlock("p", {
                key: 0,
                class: ui.value.statusCode({ class: props.ui?.statusCode })
              }, [
                renderSlot(_ctx.$slots, "statusCode", {}, () => [
                  createTextVNode(toDisplayString(props.error?.statusCode), 1)
                ])
              ], 2)) : createCommentVNode("", true),
              !!props.error?.statusMessage || !!slots.statusMessage ? (openBlock(), createBlock("h1", {
                key: 1,
                class: ui.value.statusMessage({ class: props.ui?.statusMessage })
              }, [
                renderSlot(_ctx.$slots, "statusMessage", {}, () => [
                  createTextVNode(toDisplayString(props.error?.statusMessage), 1)
                ])
              ], 2)) : createCommentVNode("", true),
              props.error?.message && props.error.message !== props.error.statusMessage || !!slots.message ? (openBlock(), createBlock("p", {
                key: 2,
              ...
              !!__props.clear || !!slots.links ? (openBlock(), createBlock("div", {
                key: 3,
                class: ui.value.links({ class: props.ui?.links })
              }, [
                renderSlot(_ctx.$slots, "links", {}, () => [
                  __props.clear ? (openBlock(), createBlock(_sfc_main$o, mergeProps({
                    key: 0,
                    size: "lg",
                    color: "primary",
                    variant: "solid",
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/@nuxt/ui/dist/runtime/components/Error.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UFooter, _attrs, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="text-muted text-sm"${_scopeId}> PeterH3G Pages © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())}</p>`);
          } else {
            return [
              createVNode("p", { class: "text-muted text-sm" }, " PeterH3G Pages © " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()), 1)
            ];
          }
        }),
        _: 1
...
const __nuxt_component_6 = Object.assign(_sfc_main$2, { __name: "AppFooter" });
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UMain, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UError, { error: __props.error }, null, _parent3, _scopeId2));
                } else {
                  return [
...
export { ImageComponent as I, _sfc_main$p as _, useRuntimeConfig as a, _sfc_main$u as b, tryUseNuxtApp as c, useRoute as d, entry_default as default, useAsyncData as e, createError as f, __nuxt_component_0$1 as g, _export_sfc as h, get as i, transformUI as j, _sfc_main$h as k, _sfc_main$o as l, _sfc_main$r as m, _sfc_main$c as n, useLocale as o, _sfc_main$a as p, _sfc_main$5 as q, __nuxt_component_0 as r, _sfc_main$d as s, tv as t, useAppConfig as u, __nuxt_component_6 as v };
