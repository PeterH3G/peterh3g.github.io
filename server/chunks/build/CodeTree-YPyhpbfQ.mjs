...
import { u as useAppConfig, t as tv, b as _sfc_main$u } from './server.mjs';
import _sfc_main$1 from './CodeIcon-CmEInbpT.mjs';
                  ...
                  if (_push3) {
                    ...
                    return [
                      createVNode("button", {
                        ...
                        item.children?.length ? (openBlock(), createBlock(_sfc_main$u, {
                          key: 0,
                          name: isExpanded ? unref(appConfig).ui.icons.folderOpen : unref(appConfig).ui.icons.folder,
                          class: ui.value.linkLeadingIcon({ class: props.ui?.linkLeadingIcon })
...
//# sourceMappingURL=CodeTree-YPyhpbfQ.mjs.map
